...
<script src="<?= URL; ?>public/js/moment.js" type="text/javascript" type="text/javascript"></script>

<!--[Bootstrap JS]-->        
<script src="<?= URL; ?>public/bootstrap-3.3.5/dist/js/bootstrap.js" type="text/javascript"></script>


<script src="<?= URL; ?>public/js/guessing-game.js" type="text/javascript"></script>